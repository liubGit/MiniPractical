...
import com.lb.base.utils.ScreenUtils;
...
public class CommonDialogFragment extends DialogFragment {
    ...
    public void onStart() {
        super.onStart();
        getDialog().getWindow().setLayout(getResources().getDisplayMetrics().widthPixels - ScreenUtils.dip2px(40) * 2, ViewGroup.LayoutParams.WRAP_CONTENT);
...
//                .setLeftbtn("取消")
//                .setRightbtn("确定")
//                .setOnDialogClickListener(new CommonDialogFragment.OnDialogClickListener() {
//                    @Override
